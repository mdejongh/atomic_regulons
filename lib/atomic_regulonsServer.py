...
from atomic_regulonsImpl import atomic_regulons
impl_atomic_regulons = atomic_regulons(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'atomic_regulons'
        ...
        self.rpc_service.add(impl_atomic_regulons.compute_atomic_regulons,
                             name='atomic_regulons.compute_atomic_regulons',
                             types=[dict, basestring])
