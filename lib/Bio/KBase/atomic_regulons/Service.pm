package Bio::KBase::atomic_regulons::Service;
...
{
    my ($self) = @_;
    my $submod = $self->get_service_name() || 'atomic_regulons';
    my $loggers = {};
...
sub call_method {
    ...
    my $ctx = Bio::KBase::atomic_regulons::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service atomic_regulons does not require authentication.
...
package Bio::KBase::atomic_regulons::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::atomic_regulons::ServiceContext
