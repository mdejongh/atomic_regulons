...
class atomic_regulons(object):
    ...
    def compute_atomic_regulons(self, expression_values, genome_id):
        ...
        arg_hash = {'method': 'atomic_regulons.compute_atomic_regulons',
                    'params': [expression_values, genome_id],
                    'version': '1.1',
    ...
    def compute_atomic_regulons_CDS(self, genome_id):
        ...
        arg_hash = {'method': 'atomic_regulons.compute_atomic_regulons_CDS',
                    'params': [genome_id],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def compute_atomic_regulons_expressionServices(self, genome_id, sample_ids):
        ...
        arg_hash = {'method': 'atomic_regulons.compute_atomic_regulons_expressionServices',
                    'params': [genome_id, sample_ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
